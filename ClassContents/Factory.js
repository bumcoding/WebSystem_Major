...
Genesis, Spark 등 모든 차종이 모두 각각의 공장에서 생산된다면, 관리가 어려움
- 동일한 차량 옵션 등을 지정하기 어려움

=> 하나의 공장에서 생산된다면, 관리가 편함
 */
...
const spark = Car.factory('Spark', 17);
spark.run();
spark.run();
...
// SNS 클래스를 상속한 Facebook, LinkedIn 클래스들이
